(() => {
    ...
    function initSliders() {
        if (document.querySelector(".calendar-months__slider")) new core(".calendar-months__slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 0,
            autoHeight: true,
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".calendar-months__navigation .swiper-button-prev",
                nextEl: ".calendar-months__navigation .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".calendar-week__slider")) new core(".calendar-week__slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 0,
            autoHeight: true,
            ...
            touchRatio: 0,
            navigation: {
                prevEl: ".calendar-week__navigation .swiper-button-prev",
                nextEl: ".calendar-week__navigation .swiper-button-next"
            },
            on: {}
        });
    }
    ...
    if (document.querySelector(".portfolio")) {
        const portfolioBtnManage = document.querySelector(".portfolio__button");
        const portfolioDropManage = document.querySelector(".portfolio__dropdown");
        toggleActionClass(portfolioBtnManage, portfolioDropManage);
    }
    if (document.querySelector(".popup__addunclock-addblock")) {
    ...
    if (document.querySelector(".information__dropdown")) {
        const informationBtnDrop = document.querySelector(".information__btn");
